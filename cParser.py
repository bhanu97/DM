...
iteration_stmnt = WHILE +LPAR+expression+RPAR +LBRACE+statement+RBRACE|DO+LBRACE+statement+RBRACE+WHILE+LPAR+expression+RPAR+SEMI|\
                  FOR+LPAR+expression+RPAR +SEMI+LBRACE+statement+RBRACE

selection_stmnt =IF+LPAR+expression+RPAR +Optional(LBRACE)+statement+Optional(RBRACE)| IF+LPAR+expression+RPAR+statement+\
                  ZeroOrMore(ELSE+IF+LPAR+expression+RPAR+LBRACE+statement+RBRACE)+Optional(ELSE+LPAR+expression+RPAR+ LBRACE+statement+RBRACE)|SWITCH+\
                  LPAR+expression+RPAR+Literal(':')+LBRACE+statement+RBRACE
...
statement << labeled_stmnt |expression_stmnt|selection_stmnt|iteration_stmnt|jump_stmnt|compound_stmnt
